...
Vl  =172.*1.;       %maximum specific uptake rate of fast pool, [1/yr]
Vs  =32.*1.;        %maximum specific uptake rate of slow pool, [1/yr]
...
Ks  =363871*0.75;   %half saturation parameter of slow pool, [gC m^-2], multiply 0.1 will show more bloated CUE dynamics for VIS model, sDEB model and mDEB model 
